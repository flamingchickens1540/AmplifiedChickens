...
<script lang=ts>
    ...
    <h3 class="grid col-start-1 col-span-1 row-start-1 text-center" style="background-color: #00D586; color: #353839; padding: 0.1rem">✓Stayed Home</h3>
    ...
    <div class="grid grid-cols-2 grid-rows-1 place-items-center">
        ...
        <h3 class="grid col-start-2 col-span-1 row-start-1 text-center" style="background-color: #00D586; color: #353839;">✓Left Home</h3>
        </div>
    {/if}
