<script lang="ts">
    ...
    let list: { letter: string, time: number }[] = [];
    let pressed = false
    ...
    function F() {
        list.push({letter: "F", time: timer});  
    }
    function E() {
        list.push({letter: "E", time: timer});
    }
    function D() {
        list.push({letter: "D", time: timer});  
    }
    function C() {
        list.push({letter: "C", time: timer}); 
    }
    function B() {
        list.push({letter: "B", time: timer});
    console.log(list)
    }
    function A() {
