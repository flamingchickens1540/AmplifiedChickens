...
async fn homepage(Extension(oauth_id): Extension<String>) -> Html<String> {
    ...
    let url = format!(
        ...
        oauth_id, scopes, slack_redirect_url
    );
