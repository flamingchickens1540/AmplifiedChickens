...
pub async fn submit_team_match(state: &AppState, form: TeamMatch) -> impl IntoResponse {
...
pub async fn submit_pit_data(state: &AppState, form: TeamEvent) -> impl IntoResponse {
